              ...
              Row(
                ...
                children: [
                  Text('${data.data!.type.validate().split('_').join(' ').capitalizeFirstLetter()}',
                      style: boldTextStyle(color:Colors.black,size: 16,fontFamily: GoogleFonts.mulish().fontFamily,weight: FontWeight.w700)).expand(),
                  Text(data.createdAt.validate(), style: secondaryTextStyle(size: 12,color: grey757575,fontFamily: GoogleFonts.mulish().fontFamily,weight: FontWeight.w700)),
                ],
              ),
              4.height,
