import 'package:home_service_user/component/shimmer_widget.dart';
          ...
          AnimatedListView(
            ...
            itemBuilder: (_, index) {
              return Container(
                ...
                decoration: BoxDecoration(color: context.scaffoldBackgroundColor, border: Border.all(color:context.scaffoldBackgroundColor ), borderRadius: radius()),
                child: Column(
                  children: [
                    Row(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          8.height,
                          Divider(height: 0, color: context.cardColor),
                          ShimmerWidget(height: 10, width: context.width()),
                          8.height,
                          Divider(height: 0, color: context.cardColor),
                          ShimmerWidget(height: 10, width: context.width()),
