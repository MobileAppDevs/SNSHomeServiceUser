...
import 'package:home_service_user/screens/booking/component/booking_history_list_widget.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(language.bookingHistory, style: boldTextStyle(size: LABEL_TEXT_SIZE, color: pureBlack),),
              ...
              widget.data.isNotEmpty
                  ...
                  : Text(language.noDataAvailable,style: GoogleFonts.mulish(
                fontSize: 14,
