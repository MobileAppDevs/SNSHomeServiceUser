    ...
    return Padding(
      ...
      child: DottedBorderWidget(
        ...
        child: Row(
          ...
          children: [
            Text(widget.text ?? '${language.lblServiceTotalTime}: ', style: primaryTextStyle(size: 12,color: pureBlack,fontFamily: GoogleFonts.mulish().fontFamily)),
            Text(calculateTime(value), style: boldTextStyle(color: Colors.red, size: 14,fontFamily: GoogleFonts.mulish().fontFamily)),
          ],
        ),
