...
import 'package:home_service_user/screens/chat/user_chat_screen.dart';
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(widget.handymanData.displayName.validate(), style: boldTextStyle(color:pureBlack)).flexible(),
                        16.width,
                        ic_info.iconImage(size: 20,color:pureBlack),
                      ],
                    ),
                    4.height,
              ...
              children: [
                ...
                AppButton(
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      ic_chat.iconSvgImage(size: 18, ),
                      8.width,
                      Text(language.lblChat, style: boldTextStyle(color:white)),
                    ],
                  ).fit(),
                  width: context.width(),
                  elevation: 0,
