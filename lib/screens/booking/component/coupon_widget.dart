                          ...
                          itemBuilder: (context, index) {
                            ...
                            return DottedBorderWidget(
                              ...
                              child: Container(
                                ...
                                color: selectedIndex == index ? primaryColor.withOpacity(0.15) : context.cardColor,
                                child: Text(
                                  data.code.validate(),
                                  style: primaryTextStyle(color: selectedIndex == index ? primaryColor : null),
                                ),
                              ),
                            ).onTap(() {
                        ...
                        widget.couponData[selectedIndex ?? 0].discountType == SERVICE_TYPE_FIXED
                            ? Row(
                                children: [
                                  ...
                                  Text(" ${language.lblOff.toLowerCase()}", style: primaryTextStyle(color:black1A1C1E)),
                                ],
                              )
                            : Text("${widget.couponData[selectedIndex ?? 0].discount.validate()}% ${language.lblOff.toLowerCase()}", style: primaryTextStyle(color:black1A1C1E)),
                        16.height,
                        RichTextWidget(
                          list: [
