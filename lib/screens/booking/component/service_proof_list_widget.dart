...
import 'package:home_service_user/screens/zoom_image_screen.dart';
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            if (data.title.validate().isNotEmpty) Text(data.title.validate(), style: boldTextAutoStyle(context: context,commonColor: black1A1C1E), maxLines: 1, overflow: TextOverflow.ellipsis),
