...
import 'package:home_service_user/model/slot_data.dart';
import 'package:home_service_user/network/rest_apis.dart';
import 'package:home_service_user/screens/booking/component/available_slots_component.dart';
...
import 'package:home_service_user/utils/extensions/int_extension.dart';
import 'package:home_service_user/utils/model_keys.dart';
import 'package:home_service_user/utils/widgets/horizontal_calender/date_item.dart';
import 'package:home_service_user/utils/widgets/horizontal_calender/date_picker_controller.dart';
import 'package:home_service_user/utils/widgets/horizontal_calender/horizontal_date_picker.dart';
                ...
                children: [
                  SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        8.height,
                        Text(language.lblSelectDate, style: boldTextStyle(size: LABEL_TEXT_SIZE,color: black1A1C1E)),
                        16.height,
                        ...
                        16.height,
                        Text(language.availableSlots, style: boldTextStyle(size: LABEL_TEXT_SIZE,color: black1A1C1E)),
                        16.height,
                        temp.isNotEmpty
                            ...
                            : appStore.isLoading
                                ? LoaderWidget()
                                : NoDataWidget(title: language.noTimeSlots,titleTextStyle:  GoogleFonts.mulish(
                          fontSize: 14,
                    ...
                    children: [
                      Container(
                        ...
                        child: AppButton(
                          ...
                          color: appStore.isDarkMode ? white/*context.scaffoldBackgroundColor*/ : white,
                          textColor: appStore.isDarkMode ? primaryColor/*white*/ : primaryColor,
                          onTap: () {
                            finish(context);
                          },
                        ),
