                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: boldTextStyle(size: 18,weight: FontWeight.w700, fontFamily: GoogleFonts.mulish().fontFamily,color: black1A1C1E),
                          ),
                          8.height,
                          Text(aboutMe, style: primaryTextStyle(weight: FontWeight.w400,color: black1A1C1E, fontFamily: GoogleFonts.mulish().fontFamily)),
                          16.height,
