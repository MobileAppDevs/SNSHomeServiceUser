...
import 'package:home_service_user/app_theme.dart';
              ...
              children: [
                Row(
                  children: [
                    ...
                    16.width,
                    Text('${widget.data.serviceName.validate()}', style: boldTextAutoStyle(context: context,commonColor: black1A1C1E)).flexible(),
                  ],
                ),
                16.height,
                Container(
                ...
                Row(
                  children: [
                    AppButton(
                      ...
                      color: /*context.scaffoldBackgroundColor*/greyAEAEB2,
