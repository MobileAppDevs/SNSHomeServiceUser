                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: boldTextStyle(color: appStore.isDarkMode ? primaryColor/*white*/ : primaryColor, size: 12),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                      8.height,
                                ...
                                if (widget.serviceData!.providerName.validate().isNotEmpty)
                                  Marquee(
                                    child: Text(
                                      ...
                                      style: secondaryTextStyle(size: 12, color: appStore.isDarkMode ? appTextSecondaryColor/*Colors.white*/ : appTextSecondaryColor),
                                    ),
                                  ).expand()
                              ],
                            )
