...
class _BookPostJobRequestScreenState extends State<BookPostJobRequestScreen> {
  ...
  void selectDateAndTime(BuildContext context) async {
    await showDatePicker(
      ...
      builder: (_, child) {
        return Theme(
          data: appStore.isDarkMode ? AppTheme.lightTheme() /*ThemeData.dark()*/ : AppTheme.lightTheme(),
          child: child!,
        );
      },
    ).then((date) async {
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  24.height,
                  Text(language.lblConfirmBooking, style: boldTextStyle(size: 20,color: black0656A5)),
                  16.height,
                  Text(language.lblConfirmMsg, style: primaryTextStyle(color:black1A1C1E), textAlign: TextAlign.center),
                  16.height,
                  Row(
                    children: [
                      AppButton(
              ...
              Form(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(language.lblDateAndTime, style: boldTextStyle(size: LABEL_TEXT_SIZE,color: Colors.black)),
                      8.height,
                      AppTextField(
                      ...
                      20.height,
                      Text(language.lblYourAddress, style: boldTextStyle(size: LABEL_TEXT_SIZE,color: Colors.black)),
                      8.height,
                      AppTextField(
