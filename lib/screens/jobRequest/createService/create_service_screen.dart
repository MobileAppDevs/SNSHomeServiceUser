              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: DottedBorderWidget(
                      ...
                      child: Column(
                        ...
                        children: [
                          Image.asset(selectImage, height: 25, width: 25, color: appStore.isDarkMode ? gray/*white*/ : gray),
                          8.height,
                          Text(language.chooseImages, style: boldTextAutoStyle(context: context,commonColor: black1A1C1E)),
                        ],
                  ...
                  DropdownButtonFormField<CategoryData>(
                    ...
                    hint: Text(language.selectCategory, style: secondaryTextStyle(size: 14,
                        weight: FontWeight.w400, fontFamily: GoogleFonts.mulish().fontFamily, color: black1A1C1E)),
                  ...
                  AppTextField(
                    ...
                    decoration: inputDecoration(context,),
                    title:language.serviceDescription ,
                    titleTextStyle:GoogleFonts.mulish(
                      fontSize: 15,
                      fontWeight: FontWeight.w500,
                      color: grey6C7278,
