          ...
          children: [
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    Text(widget.data.title.validate(), style: boldTextAutoStyle(context: context,commonColor: black1A1C1E), maxLines: 2, overflow: TextOverflow.ellipsis).expand(),
                    Container(
                      ...
                      child: Text(
                        ...
                        style: boldTextAutoStyle(context:context,commonColor: /*widget.data.status.validate().getJobStatusColor*/grey636D77, size: 12),
                      ),
                    ),
                  ],
                ),
                ...
                PriceWidget(
                  ...
                  color: /*textPrimaryColorGlobal*/primaryColor,
                  isFreeService: false,
                  size: 14,
                ),
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      icon: ic_delete_png.iconImage(size: 16),
