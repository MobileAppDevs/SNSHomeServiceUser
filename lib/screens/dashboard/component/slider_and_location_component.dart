...
import 'dashboard_location_bottom_sheet.dart';
        ...
        child: Column(
          children: [
            widget.sliderList.isNotEmpty
              ...
              SizedBox(height: 24,),
            if (widget.sliderList.length.validate() > 1) // Dot indicator
              DotIndicator(
           ...
           /* if (appStore.isLoggedIn)  // Notification
              Container(
                  ...
                  return AppButton(
                   color: Colors.transparent,
                    ...
                    child: Row(
                      ...
                      children: [
                        ic_location.iconImageVariable(height:16,width: 11),
                        8.width,
                        Text(
                    ...
                    onTap: () async {
                      showModalBottomSheet(
                        ...
                        builder: (_) {
                          return DashboardLocationBottomSheet(
                            callback: () {
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: ic_search.iconImageVariable(height: 36, width: 36).center(),
                    ),
                  ),
                  ...
                  if (appStore.isLoggedIn)  // Notification
                    Container(
                      ...
                      child: Stack(
                        clipBehavior: Clip.none,
                        children: [
                          ic_notification.iconImageVariable(height: 36, width: 36).center(),
                          Observer(builder: (context) {
                            return Positioned(
                              top: -15,
                              right: -3,
                              child: appStore.unreadCount.validate() > 0
                                  ?Container(
                                padding: EdgeInsets.all(6), // Optional: for spacing
