...
import 'package:home_service_user/screens/category/shimmer/category_shimmer.dart';
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: appBarWidget(
          ...
          color: primaryColor,
          systemUiOverlayStyle: SystemUiOverlayStyle(statusBarIconBrightness: appStore.isDarkMode ? Brightness.light : Brightness.light, statusBarColor: primaryColor),
                      ...
                      AnimatedWrap(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              ViewAllServiceScreen(categoryId: data.id.validate(), categoryName: data.name,categoryDescription:data.description, isFromCategory: true).launch(context);
                            },
