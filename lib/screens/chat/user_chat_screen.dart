...
//import 'package:firebase_pagination/firebase_pagination.dart' show FirestorePagination, ViewType,;
import 'package:firebase_pagination/firebase_pagination.dart';
...
import 'package:home_service_user/model/chat_message_model.dart';
import 'package:home_service_user/model/user_data_model.dart';
import 'package:home_service_user/screens/chat/widget/chat_item_widget.dart';
import 'package:home_service_user/services/notification_services.dart';
      ...
      children: [
        AppTextField(
         ...
         /* textStyle: primaryTextStyle(),*/
          ...
          cursorHeight: 20,
          maxLines: 5,
          cursorColor: appStore.isDarkMode ? Colors.black/*Colors.white*/ : Colors.black,
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: appBarWidget(
          ...
          color: primaryColor,
          systemUiOverlayStyle: SystemUiOverlayStyle(statusBarColor: primaryColor, statusBarBrightness: Brightness.dark, statusBarIconBrightness: Brightness.light),
          titleWidget: Text(
            ...
            PopupMenuButton(
              ...
              itemBuilder: (context) {
                ...
                list.add(
                  PopupMenuItem(
                    value: 0,
                    child: Text(language.clearChat, style: primaryTextStyle(color:black1A1C1E)),
                  ),
                );
                return list;
              },
