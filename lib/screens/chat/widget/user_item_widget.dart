...
import 'package:home_service_user/screens/chat/widget/last_messege_chat.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserData>(
      ...
      builder: (context, snap) {
                ...
                children: [
                  if (data.profileImage.validate().isEmpty)
                    Container(
                      ...
                      child: Text(data.displayName.validate()[0].validate().toUpperCase(), style: boldTextStyle(color: primaryColor)).center().fit(),
        ...
        return Container(
          padding: EdgeInsets.all(16),
          child: Text(language.loadingChats, style: primaryTextStyle(color:black1A1C1E)),
        );
      },
    );
  }
