          ...
          ? Column(
              ...
              children: [
                Text(
                  ...
                  style: primaryTextStyle(color: widget.chatItemData!.isMe! ? Colors.white : primaryColor),
                  maxLines: null,
                ),
                1.height,
                Row(
          ...
          : messageTypes == MessageType.Files.name
              ? Column(
                  ...
                  children: [
                    ...
                    Text(
                      widget.chatItemData!.message!,
                      style: primaryTextStyle(color: widget.chatItemData!.isMe! ? Colors.white : /*textPrimaryColorGlobal*/primaryColor),
                      maxLines: null,
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: primaryTextStyle(color:black1A1C1E),
                    ).onTap(() {
                      finish(context, 1);
                    }),
                  ),
