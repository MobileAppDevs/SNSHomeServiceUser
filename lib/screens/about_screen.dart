    ...
    return AppScaffold(
      ...
      child: AnimatedScrollView(
        ...
        children: [
          ...
          16.height,
          Text(APP_NAME, style: boldTextStyle(size: 16,fontFamily: GoogleFonts.mulish().fontFamily,color: black1A1C1E)),
          8.height,
          ...
          Align(
            ...
            child: Text(getStringAsync(SITE_DESCRIPTION), style: primaryTextStyle(color:black1A1C1E), textAlign: TextAlign.justify),
          ),
          30.height,
          Padding(
