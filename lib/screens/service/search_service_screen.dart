...
class _SearchServiceScreenState extends State<SearchServiceScreen> {
  ...
  bool get showRecommended {
    return searchCont.text.length <= 3 && !isFilterApplied;
  }
                ...
                children: [
                  ...
                  /* Container(
                    ...
                    decoration: boxDecorationDefault(color: primaryColor),
                     child: ic_filter_bar.iconImageVariable(
                         color: white, height: 13, width: 24),
                    ...
                    ? Column(
                        ...
                        children: [
                          Text(language.recommendedForYou,
                                  style: boldTextAutoStyle(size: LABEL_TEXT_SIZE, context: context,commonColor: black1A1D1F))
                          ...
                          AnimatedListView(
                            ...
                            itemBuilder: (_, index) {
                              return ProviderServiceComponent(
                                      serviceData:
                                          widget.featuredList.validate()[index])
                                  .paddingAll(8);
                            },
                          ).paddingAll(8),
                        ],
