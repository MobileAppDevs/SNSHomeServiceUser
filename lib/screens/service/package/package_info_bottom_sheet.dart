          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(language.getTheseServiceWithThisPackage, style: secondaryTextStyle(color: Colors.black)),
                8.height,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Marquee(child: Text(data.name.validate(), style: boldTextStyle(size: LABEL_TEXT_SIZE,color: Colors.black))),
                                4.height,
                                  ...
                                  Marquee(
                                    child: Row(
                                      children: [
                                        ...
                                        Text('${data.subCategoryName}', style: boldTextStyle(size: 12, color: primaryColor)),
                                      ],
                                    ),
                                  )
                                else
                                  Text('${data.categoryName}', style: boldTextStyle(size: 14, color: primaryColor)),
                                4.height,
                                PriceWidget(
