...
class _UserWalletBalanceScreenState extends State<UserWalletBalanceScreen> {
  ...
  List<int> defaultAmounts = [25,50,100,200,500,1000];
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    Text(language.balance, style: boldTextStyle(color: primaryColor)).expand(),
              ...
              Column(
                ...
                children: [
                  16.height,
                  Text(language.topUpWallet, style: boldTextStyle(size: LABEL_TEXT_SIZE, color: pureBlack)),
                  8.height,
                          ...
                          children: List.generate(defaultAmounts.length, (index) {
                            return Container(
                              ...
                              child: Text(
                                ...
                                style: primaryTextStyle(color: defaultAmounts[index].toString() == walletAmountCont.text ? primaryColor : Colors.white),
                              ),
                            ).onTap(() {
                  ...
                  16.height,
                  Text(language.paymentMethod, style: boldTextStyle(size: LABEL_TEXT_SIZE,color: Colors.black)),
                  4.height,
