...
import 'package:home_service_user/component/base_scaffold_widget.dart';
import 'package:home_service_user/main.dart';
import 'package:home_service_user/screens/blog/blog_repository.dart';
import 'package:home_service_user/screens/blog/component/blog_detail_header_component.dart';
import 'package:home_service_user/screens/blog/model/blog_detail_response.dart';
import 'package:home_service_user/utils/extensions/string_extentions.dart';
          ...
          return AnimatedScrollView(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(data.blogDetail!.title.validate(), style: boldTextStyle(size: 20,fontFamily: GoogleFonts.mulish().fontFamily,color: black1A1C1E)),
                  8.height,
                  Row(
                    children: [
                      ImageBorder(
