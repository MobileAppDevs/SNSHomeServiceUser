...
import '../booking/component/price_common_widget.dart';
...
class PaymentScreen extends StatefulWidget {
  ...
  PaymentScreen({required this.bookings, this.isForAdvancePayment = false,this.bookingAmountModel});
        ...
        children: [
          Column(
            ...
            children: [
                  ...
                  PriceCommonWidget(
                    ...
                    bookingPackage:
                        widget.bookings.bookingDetail!.bookingPackage != null
                            ...
                            : null,
                    bookingAmountModel: widget.bookingAmountModel,
                  ),
                  32.height,
                  Text(language.lblChoosePaymentMethod,
                      style: boldTextStyle(size: LABEL_TEXT_SIZE,fontStyle: GoogleFonts.mulish().fontStyle,
                        color: black1A1C1E,
                        weight: FontWeight.w800,)),
                ],
              ).paddingAll(16),// heading Choose Payment method
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return RadioListTile<PaymentSetting>(
                        ...
                        title: Text(value.title.validate(),
                            style: primaryTextStyle(fontStyle: GoogleFonts.mulish().fontStyle,
                              color: black1A1C1E,
              ...
              ), // list which came from backend ,List of payment method
              if (/*appConfigurationStore.isEnableUserWallet*/false)
