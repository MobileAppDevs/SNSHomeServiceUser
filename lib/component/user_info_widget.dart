...
import '../screens/booking/provider_info_screen.dart';
import '../utils/colors.dart'; // Assuming this is the correct path for colors
import '../utils/images.dart'; // Assuming this is the correct path for images
import '../utils/string_extensions.dart'; // Assuming this is the correct path for string extensions
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        if (widget.data.isProvider)
                          Container(
                            ...
                            child: widget.data.isFavourite == 1 ? ic_fill_heart.iconImage(color: favouriteColor, size: 20) : ic_heart.iconSvgImage(color: unFavouriteColor, size: 20),
                          ).onTap(() async {
                    ...
                    Row(
                      ...
                      children: [
                        Marquee(child: Text(widget.data.displayName.validate(), style: boldTextStyle(size: 18,color: black1A1C1E,fontFamily: GoogleFonts.mulish().fontFamily))).flexible(),
                        8.width,
