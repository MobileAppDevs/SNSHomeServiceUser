    ...
    return SafeArea(
      ...
      child: Stack(
        children: [
          Container(
            width: widget.width,
            decoration: boxDecorationWithRoundedCorners(borderRadius: radius(20), backgroundColor: appStore.isDarkMode ?white /*context.scaffoldBackgroundColor*/ : white,
            border: Border.all(color: innerAlignColor,width: 1)),
            child: Column(
              ...
              children: [
                ...
                Marquee(
                  ...
                  child: Text(widget.data!.displayName.validate(), style: boldTextStyle(
          ...
          if (widget.isFavouriteProvider)
            Positioned(
             ...
             //   decoration: boxDecorationWithShadow(boxShape: BoxShape.circle, backgroundColor: context.cardColor),
                child: widget.data!.isFavourite == 1 ? ic_heart_fill.iconSvgImage(color: favouriteColor, size: 18) : ic_heart.iconImage(color: unFavouriteColor, size: 22),
              ).onTap(() async {
